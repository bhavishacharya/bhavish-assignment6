...
<body>
<h1 align="center">Employees Detail</h1>
<p>1. Display all employees detail.</p>
...
<p>5. It checks key as DOB to be present and then prints the employees detail, otherwise display an error message.</p>
<table border="1" align="center">
<tr>
	<th>Eno</th>
	<th>Name</th>
